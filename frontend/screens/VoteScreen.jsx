    ...
    <View style={styles.container}>
      <View>
        <Image
          ...
          resizeMode="cover"
        />
        <Text style={{ fontSize: 30 }}>Martins Paul</Text>
        <Text style={{ fontSize: 14, color: "gray" }}>MALE</Text>
      </View>

      <Text style={{ width: 300, color: "gray", marginTop: 20 }}>
        You have successfully Voted this candidate as your choice
      </Text>

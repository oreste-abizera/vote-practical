...
const CandidateDetailsScreen = ({ navigation, route }) => {
    ...
    <View style={styles.container}>
      <View>
        <Image
          ...
          resizeMode="cover"
        />
        <Text style={{ fontSize: 30 }}>Names: {candidate.names}</Text>
        <Text style={{ fontSize: 16 }}>
          Gender: <Text style={{ color: "gray" }}>{candidate.gender}</Text>
        </Text>
        <Text style={{ fontSize: 16, marginVertical: 10 }}>
          Mission Statement:
          <Text style={{ color: "gray" }}>{candidate.missionStatement}</Text>
        </Text>
        <Text style={{ fontSize: 16, marginBottom: 10 }}>
          National ID:{" "}
          <Text style={{ color: "gray" }}>{candidate.nationalId}</Text>
        </Text>
        <Text style={{ fontSize: 16 }}>
          Votes:{" "}
          <Text style={{ color: "gray" }}>{candidate.votes?.length || 0}</Text>
        </Text>
      </View>
